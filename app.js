    ...
    fetch("config.json")
        ...
        .then((data) => {
            ...
            data.Info.Section.forEach((section) => {
                ...
                const isspecialBetEnabled = section.sectionType === "specialBet" && gamehasSpecialBet;
                ...
                if (isBuyBonusEnabled || isspecialBetEnabled || isBurningModeEnabled || isHunterModeEnabled) {
...
function createbuyBonusSection(mainSection, subSection, subContainer) {
    ...
    const isspecialBetEnabled = mainSection.sectionType === "specialBet" && gamehasSpecialBet;
